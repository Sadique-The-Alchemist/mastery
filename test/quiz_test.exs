defmodule QuizTest do
  ...
  describe "when a quiz has two templates" do
    ...
    test "nex question is randomly selected", %{quiz: quiz} do
  ...
  describe "a quiz that always add one and two" do
    setup [:quiz_always_add_one_and_two]
  ...
  defp quiz_always_add_one_and_two(context) do
