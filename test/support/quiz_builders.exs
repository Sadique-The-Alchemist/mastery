defmodule QuizBuilders do
  ...
  def template_fields(ovverides \\ []) do
    Keyword.merge(
      [
        name: :single_digit_adition,
        category: :addition,
  ...
  def quiz_fields(overrides) do
    Keyword.merge([title: "Simple Arithematic"], overrides)
  end
  ...
  def build_quiz_with_two_templates(quiz_ovverides \\ []) do
    build_quiz(quiz_ovverides)
